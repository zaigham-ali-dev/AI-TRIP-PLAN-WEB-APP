            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="mt-6 sm:mt-7 flex flex-col gap-4.5">
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="signup-name" className="text-[13px] font-bold text-[#0e1326] tracking-tight">
                    Full name
                  </label>
                  <input
                    id="signup-name"
                ...
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="signup-email" className="text-[13px] font-bold text-[#0e1326] tracking-tight">
                    Email address
                  </label>
                  <input
                    id="signup-email"
                ...
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="signup-password" className="text-[13px] font-bold text-[#0e1326] tracking-tight">
                    Password
                  </label>
                ...
                <div className="flex items-center gap-2.5 mt-0.5">
                  <button
                    ...
                    className={`w-[18px] h-[18px] rounded-[5px] border-2 flex items-center justify-center shrink-0 transition-all cursor-pointer disabled:opacity-60 ${
                      agreeTerms ? "bg-blue-600 border-blue-600" : "bg-white border-slate-300 hover:border-slate-400"
                    }`}
                  >
                    {agreeTerms && (
                ...
                <button
                  type="submit"
                  disabled={loading || googleLoading}
                  className="w-full h-[48px] bg-blue-600 hover:bg-blue-700 active:scale-[0.98] text-white font-bold text-[15px] rounded-xl shadow-md shadow-blue-600/20 transition-all cursor-pointer mt-1 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {loading ? (
                    <>
              ...
              <p className="mt-5 text-center text-[13.5px] text-[#64748b] font-medium">
                ...
                <Link
                  href={redirectTarget ? `/signin?redirect_url=${encodeURIComponent(redirectTarget)}` : "/signin"}
