              ...
              <form onSubmit={handleSubmit} className="mt-6 sm:mt-7 flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-1.5">
                  <div className="flex items-center justify-between">
                    ...
                    <Link
                      href="#"
                      className="text-[12.5px] font-semibold text-blue-600 hover:text-blue-700 transition-colors"
                    >
                      Forgot password?
                    </Link>
                  </div>
                ...
                <div className="flex items-center gap-2.5">
                  <button
                    ...
                    disabled={loading || googleLoading}
                    className={`w-[18px] h-[18px] rounded-[5px] border-2 flex items-center justify-center shrink-0 transition-all cursor-pointer disabled:opacity-60 ${rememberMe
                ...
                <button
                  type="submit"
                  disabled={loading || googleLoading}
                  className="w-full h-[48px] bg-blue-600 hover:bg-blue-700 active:scale-[0.98] text-white font-bold text-[15px] rounded-xl shadow-md shadow-blue-600/20 transition-all cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
                >
